...
public class StatementPropertiesDialog extends StruckerDialog {
    ...
    public StatementPropertiesDialog(Statement target) {
        super();
        this.target = target;
        initComponents();
        definitionField.setText(target.getStatement());
    ...
    private void initComponents() {
        ...
        setTitle("Kifejezés tulajdonságai");
